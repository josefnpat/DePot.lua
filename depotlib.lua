...
function depot._decode(iterator)
...
function depot.decode(str)

  return depot._decode(function() return str:gmatch("[^\r\n]+") end)

end

function depot.decode_file(filename)

  local f = io.open(filename,"rb")
  local tmp = depot._decode(function() return f:lines() end)
  f:close()
